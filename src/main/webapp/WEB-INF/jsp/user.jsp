    ...
    <div class="login-card">
        ...
        <div class="user-ipt">
            ...
            <form:form action="${save_user_url}" method="post" modelAttribute="user">
                ...
                <form:input type="text" id="first_name" path="first_name" required="required"/>

                <label for="last_name">User Last Name:</label>
                <form:input type="text" id="last_name" path="last_name" required="required"/>

                <label for="email">User Email:</label>
                <form:input type="text" id="email" path="email" required="required"/>

                <label for="password">User Password:</label>
                <form:input type="password" id="password" path="password" required="required"/>

                <label for="role_name">User Role:</label>
                <form:input type="text" id="role_name" path="role_name" required="required"/>
        ...
        <div class="login-links">
            <p><a href="/app/users/${user.id}">Back</a></p>
        </div>
    </div>
</div>
</body>
